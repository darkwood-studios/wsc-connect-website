		...
		return (
			<div>
				...
				<div>
					...
					<div><Badge color="info"><FormattedMessage id="wsc.version" values={{version: "1.0.7"}} /></Badge></div>
				...
				<div className="mt-3">
					...
					<div><Badge color="info"><FormattedMessage id="wsc.version" values={{version: "3.0.7"}} /></Badge></div>
				...
				<div className="mt-3">
					...
					<div><Badge color="info"><FormattedMessage id="wsc.version" values={{version: "2.0.7"}} /></Badge></div>
